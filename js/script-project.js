...
const projects = [{
  ...
  },
  {
    ...
    description: "Option A, you kill me right here and now. Apparently I've made that very easy for you. You can kill me, no witnesses and then spend the next few weeks or months tracking down Jesse Pinkman and you kill him too. A pointless exercise.",
    image: 'blog-zenchef',
    link: ' '
  },
  {
  ...
  },
  {
    ...
    description: "Option A, you kill me right here and now. Apparently I've made that very easy for you. You can kill me, no witnesses and then spend the next few weeks or months tracking down Jesse Pinkman and you kill him too.",
    image: 'maroquinerie',
    link: ' '
  }
];
...
function main() {
  ...
  //Traiter l'url pour générer le bon contenu automatiquement

  //Generate good project ID from URL
  let initialURL = window.location.href;
  let positionAfterHyphen = initialURL.lastIndexOf('-') + 1;
  let idProject = initialURL.substring(positionAfterHyphen, (positionAfterHyphen + 1)) - 1;
